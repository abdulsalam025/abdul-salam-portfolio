    ...
    <div className={darkMode ? "app dark" : "app light"}>
      ...
      <main>
        ...
        <section className="section about-section" id="about">
          <div className="section-label">01 Ã¢â‚¬â€ ABOUT ME</div>
        ...
        <section className="section education-section" id="education">
          <div className="section-label">02 Ã¢â‚¬â€ EDUCATION</div>
          ...
          <div className="education-card">
            ...
            <div className="education-content">
              ...
              <h3>
                Bachelor of Engineering Ã¢â‚¬â€ Artificial Intelligence & Machine Learning
              </h3>
        ...
        <section className="section" id="skills">
          <div className="section-label">03 Ã¢â‚¬â€ SKILLS</div>
        ...
        <section className="section" id="projects">
          <div className="section-label">04 Ã¢â‚¬â€ PROJECTS</div>
        ...
        <section className="section contact-section" id="contact">
          <div className="section-label">05 Ã¢â‚¬â€ CONTACT</div>
          ...
          <div className="contact-box">
            ...
            <a href="mailto:abdulsalam024.main@gmail.com" className="primary-button">
              Send me an email
              <Mail size={18} />
            </a>
          </div>
  ...
  >
    ...
    >
      ...
      <footer>
        ...
        <p>Ãƒâ€šÃ‚Â© 2026 Abdul Salam. Built with React.</p>
